...
import { AuthenticationEnrichment } from '../express-common/middleware/authentication-middleware-factory';
import { LoggerEnrichment } from '../express-common/middleware/logger-middleware-factory';
import { Endpoint, EndpointResponse, HttpHandler, MimeType, ResponseType } from '../express-common/model/handlers';
...
export class ExpressHttpAdapter {
  public expressHandler(
    ...
    return async (
      ...
      const handler: ResponseHandler = this.handler(responseType, response, next);
