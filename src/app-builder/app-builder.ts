...
export class AppBuilder {
  ...
  public withAppEndpoints(versionTag: string, endpoints: Endpoints): AppBuilder {
  ...
  public withInternalEndpoints(versionTag: string, endpoints: Endpoints): AppBuilder {
  ...
  public withApiEndpoints(versionTag: string, endpoints: Endpoints): AppBuilder {
  ...
  public withPublicEndpoints(versionTag: string, endpoints: Endpoints): AppBuilder {
  ...
  public withPubSubEndpoints(versionTag: string, endpoints: Endpoints): AppBuilder {
  ...
  private withDefaultRoute(consumer: Consumer, versionTag: string): AppBuilder {
  ...
  public withPublicRoute(prefix: string, versionTag: string, middleware: ExpressHandler[]): AppBuilder {
    return this.withRoute(Consumer.public, prefix, versionTag, middleware);
  }

  public withPublicRouteEndpoints(prefix: string, versionTag: string, endpoints: Endpoints): AppBuilder {
    return this.withEndpoints(Consumer.public, prefix, versionTag, endpoints);
  }
  public withPubSubRoute(prefix: string, versionTag: string, middleware: ExpressHandler[]): AppBuilder {
    return this.withRoute(Consumer.pubsub, prefix, versionTag, middleware);
  }

  public withPubSubRouteEndpoints(prefix: string, versionTag: string, endpoints: Endpoints): AppBuilder {
    return this.withEndpoints(Consumer.pubsub, prefix, versionTag, endpoints);
  }

  public withAppRoute(prefix: string, versionTag: string, middleware: ExpressHandler[]): AppBuilder {
    return this.withRoute(Consumer.app, prefix, versionTag, middleware);
  }

  public withAppRouteEndpoints(prefix: string, versionTag: string, endpoints: Endpoints): AppBuilder {
    return this.withEndpoints(Consumer.app, prefix, versionTag, endpoints);
  }

  public withInternalRoute(prefix: string, versionTag: string, middleware: ExpressHandler[]): AppBuilder {
    return this.withRoute(Consumer.internal, prefix, versionTag, middleware);
  }

  public withInternalRouteEndpoints(prefix: string, versionTag: string, endpoints: Endpoints): AppBuilder {
    return this.withEndpoints(Consumer.internal, prefix, versionTag, endpoints);
  }

  public withApiRoute(prefix: string, versionTag: string, middleware: ExpressHandler[]): AppBuilder {
    return this.withRoute(Consumer.api, prefix, versionTag, middleware);
  }

  public withApiRouteEndpoints(prefix: string, versionTag: string, endpoints: Endpoints): AppBuilder {
    return this.withEndpoints(Consumer.api, prefix, versionTag, endpoints);
  }

  private withEndpoints(consumer: Consumer, prefix: string, versionTag: string, endpoints: Endpoints): AppBuilder {
  ...
  private withRoute(consumer: Consumer, prefix: string, versionTag: string, middleware: ExpressHandler[]): AppBuilder {
    const route = this.endpoints[consumer]?.[prefix]?.[versionTag];
    if (route != null) {
